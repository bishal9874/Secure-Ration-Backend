...
class RationKYCSerializer(serializers.ModelSerializer):
    ...
    user_email = serializers.EmailField(source='rationId.email', read_only=True)
    user_name = serializers.CharField(source='rationId.name', read_only=True)
    user_rationId = serializers.CharField(source='rationId.rationId', read_only=True)
    user_face_image = serializers.ImageField(source='rationId.face_image', read_only=True)
